package com.luoys.upgrade.toolservice.client;
...
public class JdbcTemplateClient {
    ...
    public JdbcTemplateClient(DriverManagerDataSource dataSource) {
        this.dataSource = dataSource;
        this.jdbcTemplate.setDataSource(this.dataSource);
    }

    public JdbcTemplateClient(String driver, String url, String userName, String password) {
