...
public class TaskController {
    ...
    public Result<Integer> create(@RequestHeader("loginInfo") String loginInfo,
        ...
        taskVO.setOwnerId(userService.queryByLoginInfo(loginInfo).getUserId());
        return Result.success(taskService.create(taskVO));
    }

    @RequestMapping(value = "/remove", method = RequestMethod.DELETE)
    public Result<String> remove(@RequestParam("taskId") Integer taskId) {
    ...
    public Result<String> updateComment(@RequestParam("taskId") Integer taskId,
    ...
    public Result<List<TaskVO>> query(@RequestHeader("loginInfo") String loginInfo,
        ...
        return Result.success(taskService.query(userService.queryByLoginInfo(loginInfo).getUserId(), startTime, endTime));
    }
    ...
    public Result<List<TaskWeeklyVO>> queryByWeekly(@RequestHeader("loginInfo") String loginInfo,
        ...
        List<TaskWeeklyVO> weekList = taskService.queryByWeekly(userService.queryByLoginInfo(loginInfo).getUserId(), currentDate);
